...
<h1 align="center">Hi 👋, I'm Jeisson Antunez</h1>
<h3 align="center">💻 Apasionado por el Desarrollo de Software</h3>
<p align="center">
    Soy un desarrollador enfocado en crear soluciones tecnológicas innovadoras que transformen ideas en productos funcionales y escalables. 
    Mi experiencia abarca tanto el <strong>desarrollo Front End</strong> como el <strong>Back End</strong>, permitiéndome construir aplicaciones completas y eficientes.
</p>

<h3 align="center">🚀 Áreas de Expertise</h3>
<ul align="center">
    <li><strong>Back End:</strong> Desarrollo de APIs robustas con <strong>Java</strong> y <strong>Spring</strong>, y gestión eficiente de datos con <strong>MySQL</strong> y <strong>PostgreSQL</strong>.</li>
    <li><strong>Front End:</strong> Creación de interfaces dinámicas y responsivas con <strong>HTML</strong>, <strong>CSS</strong>, <strong>JavaScript</strong> y <strong>React</strong>.</li>
</ul>

<h3 align="center">🛠️ Enfoque Profesional</h3>
<p align="center">
    Me especializo en diseñar y desarrollar aplicaciones funcionales, escalables y sostenibles, integrando tecnologías modernas para resolver problemas complejos y optimizar procesos.
</p>
